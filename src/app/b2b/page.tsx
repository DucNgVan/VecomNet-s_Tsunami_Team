...
export default function B2BPage() {
  ...
  return (
    <div className="pt-24 pb-20 px-4 sm:px-8 max-w-7xl mx-auto space-y-16">
      ...
      <GlassCard className="p-8 sm:p-10 max-w-4xl mx-auto shadow-[0_12px_40px_rgba(11,30,59,0.06)] border border-slate-200/90">
        <div className="text-center space-y-2 mb-8">
          ...
          <p className="text-xs text-slate-500">
            Kéo thanh trượt để xem số liệu môi trường có thể đưa trực tiếp vào Báo cáo Phát triển Bền
            vững (Sustainability Report) hàng năm.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <GlassCard className="p-6 space-y-3 border border-slate-200/90 shadow-[0_6px_20px_rgba(11,30,59,0.04)]">
          <div className="w-12 h-12 rounded-xl bg-sky-50 text-sky-800 flex items-center justify-center text-xl font-bold">
            🏷️
          </div>
        ...
        <GlassCard className="p-6 space-y-3 border border-slate-200/90 shadow-[0_6px_20px_rgba(11,30,59,0.04)]">
          <div className="w-12 h-12 rounded-xl bg-teal-50 text-teal-800 flex items-center justify-center text-xl font-bold">
            📜
          </div>
      ...
      <div className="max-w-2xl mx-auto">
        <GlassCard className="p-8 sm:p-10 border border-slate-200/90 shadow-[0_12px_40px_rgba(11,30,59,0.06)]">
          {submitted ? (
